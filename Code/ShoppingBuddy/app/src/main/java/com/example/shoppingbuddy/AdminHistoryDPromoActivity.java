...
public class AdminHistoryDPromoActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_history_dpromo);
        ...
        promoCollection.orderBy("promoId", Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    promoLayoutManager = new LinearLayoutManager(AdminHistoryDPromoActivity.this);
                    promoAdapter = new AdminPromoAdapter(itemListArray, AdminHistoryDPromoActivity.this);
