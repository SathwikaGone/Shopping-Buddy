...
public class ClothingProductList extends AppCompatActivity
...
//        userEmail = i.getStringExtra("userEmail");
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot doc : task.getResult()) {
                        ...
                        if (doc.getString("category").equals("Men's clothing")) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            Intent i = new Intent(ClothingProductList.this, CartActivity.class);
            startActivity(i);
        }
