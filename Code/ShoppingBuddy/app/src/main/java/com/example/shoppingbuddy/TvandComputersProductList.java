...
public class TvandComputersProductList extends AppCompatActivity
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot doc : task.getResult()) {
                        ...
                        if (doc.getString("category").equals("Tv and Computers")) {
                    ...
                    productLayoutManager = new LinearLayoutManager(TvandComputersProductList.this);
                    productsAdapter = new ProductsAdapter(itemListArray, TvandComputersProductList.this);
