...
public class MensFootwearProducts extends AppCompatActivity
...
//        });
        ...
        productCollection.orderBy("itemId", Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    productLayoutManager = new LinearLayoutManager(MensFootwearProducts.this);
                    productsAdapter = new FootwearProductsAdapter(itemListArray, MensFootwearProducts.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mens_footwear_products, menu);
        return true;
    }
