...
public class FootwearProductsAdapter extends RecyclerView.Adapter<FootwearProductsAdapter.ItemsViewHolder> {
    private ArrayList<Container> itemListArray;
    private Context context;

    public FootwearProductsAdapter(ArrayList<Container> itemListArray, Context context) {
    ...
    @NonNull
    @Override
    public FootwearProductsAdapter.ItemsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_container, viewGroup, false);
        FootwearProductsAdapter.ItemsViewHolder itemsVH = new FootwearProductsAdapter.ItemsViewHolder(v);
        return itemsVH;
    }

    @Override
    public void onBindViewHolder(@NonNull final FootwearProductsAdapter.ItemsViewHolder itemsViewHolder, final int i) {
        ...
        itemsViewHolder.linearLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Footwear_Item_Details.class);
