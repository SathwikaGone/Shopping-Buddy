...
public class SelectPromocodeActivity extends AppCompatActivity
        ...
        promoCollection.orderBy("PromoId", Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    promoLayoutManager = new LinearLayoutManager(SelectPromocodeActivity.this);
                    promoAdapter = new PromocodeAdapter(itemListArray, SelectPromocodeActivity.this);
