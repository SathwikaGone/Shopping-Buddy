...
public class AdminProductsAdapter  extends RecyclerView.Adapter<ProductsAdapter.ItemsViewHolder> {

    private ArrayList<Container> itemListArray;

    public AdminProductsAdapter(ArrayList<Container> itemListArray, Context context) {
    ...
    @NonNull
    @Override
    public ProductsAdapter.ItemsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_container, viewGroup, false);
        ProductsAdapter.ItemsViewHolder itemsVH = new ProductsAdapter.ItemsViewHolder(v);
        return itemsVH;
    }

    @Override
    public void onBindViewHolder(@NonNull final ProductsAdapter.ItemsViewHolder itemsViewHolder, final int i) {
